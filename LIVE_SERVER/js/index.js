...
*/
// const experimentObject = document.querySelectorAll('.zalypa');
// console.log(experimentObject)
// const subItems = experimentObject[0].querySelectorAll('li')
...
// 	}
// }
let arbuzer = document.querySelector("ul")
console.log(arbuzer.childNodes)
